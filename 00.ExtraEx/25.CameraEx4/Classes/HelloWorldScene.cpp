...
void HelloWorld::doFrontFlip(Ref* sender) {
	auto firstHalf = OrbitCamera::create(0.5f, 1.0f, 0, 0, 90.0f, 0, 0);
	...
	auto action = Sequence::create(DelayTime::create(0.5f), CallFunc::create(CC_CALLBACK_0(HelloWorld::doBackFlip, this, this)), nullptr);
...
void HelloWorld::doBackFlip(Ref* sender) {
	...
	auto secondHalf = OrbitCamera::create(0.5f, 1.0f, 0, 270, 90.0f, 0, 0);
	if (pSprite1->isVisible()) {
