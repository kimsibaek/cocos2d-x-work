...
void HelloWorld::tick(float dt) {
	...
	else if (body0->GetPosition().x >= 13) {
		//log("ddsfdasd");
		b2Vec2 axis(1.0f, 0.0f);
		m_spring1->SetMotorSpeed(30.0f);
		m_spring2->SetMotorSpeed(30.0f);
