...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	b2Body* body2 = this->addNewSprite(Vec2(100+2, winSize.height / 2+2), Size(40, 40), b2_dynamicBody, "Images/CloseNormal.png", 0);
	...
	b2Body* body3 = this->addNewSprite(Vec2(200, winSize.height / 2), Size(60, 60), b2_dynamicBody, "test", 0);
	b2Body* body4 = this->addNewSprite(Vec2(200 + 2, winSize.height / 2 + 2), Size(40, 40), b2_dynamicBody, "Images/CloseNormal.png", 0);
