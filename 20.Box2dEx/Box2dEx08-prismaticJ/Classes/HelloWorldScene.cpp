...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	this->addNewSprite(Vec2(240, 300), Size(50, 50), b2_dynamicBody, "Images/CloseNormal.png", 0);
...
void HelloWorld::createSpring(Vec2 point, Size size) {
	...
	b2Body* body1 = this->addNewSprite(Vec2(point.x, point.y), Size(4, 20), b2_staticBody, nullptr, 0);
	//b2Body* body1 = this->addNewSprite(Vec2(point.x, point.y), Size(4, 20), b2_dynamicBody, nullptr, 0);
	b2Body* body2 = this->addNewSprite(Vec2(point.x, point.y), size, b2_dynamicBody, nullptr, 0);
	...
	priJointDef.upperTranslation = 0.8f;
