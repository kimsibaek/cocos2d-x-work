...
bool MainScene::init()
{
	...
	pMenuItem6->setTag(6);
	auto pMenuItem7 = MenuItemImage::create("Images/Scene/BackButton.png", "Images/Scene/BackButton_click.png", CC_CALLBACK_1(MainScene::doClick1, this));
	pMenuItem7->setPosition(Vec2(1190, 650));
