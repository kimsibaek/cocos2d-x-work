...
bool ItemsEquip::init()
{
	...
	auto pMenuItem2 = MenuItemImage::create("Images/Scene/Equip.png", "Images/Scene/Equip_click.png", CC_CALLBACK_1(ItemsEquip::doEquipment, this));
	...
	auto pMenuItem1 = MenuItemImage::create("Images/Scene/BackButton.png", "Images/Scene/BackButton_click.png", CC_CALLBACK_1(ItemsEquip::doClick1, this));
