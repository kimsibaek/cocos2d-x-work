...
bool ClassChange::init()
{
	...
	auto pMenuItem2 = MenuItemImage::create("Images/Scene/ClassUp.png", "Images/Scene/ClassUp_click.png", CC_CALLBACK_1(ClassChange::doContinue, this));
...
*/
	...
	pMenu->setPosition(Vec2(1050, 360));
	this->addChild(pMenu);

	auto pMenuItem1 = MenuItemImage::create("Images/Scene/BackButton.png", "Images/Scene/BackButton_click.png", CC_CALLBACK_1(ClassChange::doClick1, this));
	pMenuItem1->setPosition(Vec2(1190, 650));
