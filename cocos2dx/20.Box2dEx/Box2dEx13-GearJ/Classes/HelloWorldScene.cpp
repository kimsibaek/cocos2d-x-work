...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	b2Body* body1 = this->addNewSprite(Vec2(220, 160), Size(40, 40), b2_dynamicBody, nullptr, 1);
	//b2Body* body1 = this->addNewSprite(Vec2(point.x, point.y), Size(4, 20), b2_dynamicBody, nullptr, 0);
	b2Body* body2 = this->addNewSprite(Vec2(260, 160), Size(40, 40), b2_dynamicBody, nullptr, 1);
