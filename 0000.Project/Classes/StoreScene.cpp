...
bool StoreScene::init()
{
	...
	auto pMenuItem2 = MenuItemImage::create("Images/Scene/Buy.png", "Images/Scene/Buy_click.png", CC_CALLBACK_1(StoreScene::doBuy, this));
	//auto pMenuItem2 = MenuItemFont::create("구매", CC_CALLBACK_1(StoreScene::doBuy, this));
	//pMenuItem2->setColor(Color3B(0, 0, 0));
	auto pMenuItem3 = MenuItemImage::create("Images/Scene/Sell.png", "Images/Scene/Sell_click.png", CC_CALLBACK_1(StoreScene::doSell, this));
	...
	auto pMenuItem1 = MenuItemImage::create("Images/Scene/BackButton.png", "Images/Scene/BackButton_click.png", CC_CALLBACK_1(StoreScene::doClick1, this));
	pMenuItem1->setPosition(Vec2(1200, 670));
