...
bool FireMap::init()
{
	...
	tmap = TMXTiledMap::create("Images/Scene/FireMapTest.tmx");
...
void FireMap::onEnter() {
	...
	listener->onTouchBegan = CC_CALLBACK_2(FireMap::onTouchBegan, this);
	listener->onTouchMoved = CC_CALLBACK_2(FireMap::onTouchMoved, this);
	listener->onTouchEnded = CC_CALLBACK_2(FireMap::onTouchEnded, this);
...
void FireMap::onTouchEnded(cocos2d::Touch* touch, cocos2d::Event* event) {
...
Vec2 FireMap::tileCoordForPosition(cocos2d::Vec2 position) {
